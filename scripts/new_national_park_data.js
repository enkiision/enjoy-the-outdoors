...
//   }
  ...
  function buildTableRow(nationalPark) {
      let tr = nationalParkTbody.insertRow();
  
      let td1 = tr.insertCell();
      td1.innerText = nationalPark.LocationName;
  
      let td2 = tr.insertCell(); 
      td2.innerText = nationalPark.Address + ", Zip: " + nationalPark.ZipCode; 
  
      let td3 = tr.insertCell();
      td3.innerText = nationalPark.City + ", " + nationalPark.State; 
  
      let td4 = tr.insertCell();
      td4.innerText = nationalPark.Phone

      let td5 = tr.insertCell();
      td5.innerText = nationalPark.Website
  } 
  // Verify that nationalParksArray is defined
  for (const nationalPark of nationalParksArray) {
      buildTableRow(nationalPark);
  }
